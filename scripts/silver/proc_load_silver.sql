...
====================================================================================================================
Script Purpose:
	This stores procedure performs the ETL(Extract, Transfer, Load) process to populate
	th 'silver' schematables from the 'bronze' schema.
Actions Performed:
...
DECLARE @Start_time DATETIME, @End_Time DATETIME,@Batch_Start_time DATETIME, @Batch_End_time DATETIME
	...
	BEGIN TRY
		...
		SELECT 
		*,
		ROW_NUMBER() OVER (PARTITION BY cst_id ORDER BY cst_create_date DESC) AS last_flag -- Select the most recent record per customer
		...
		PRINT'========================================================================================='
		PRINT'Total duration for loading silver tables'
		PRINT'========================================================================================='
